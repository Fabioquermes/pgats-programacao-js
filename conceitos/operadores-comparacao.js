/**
    ...
    === - igualmente de valores e tipo de dado

 */
    // maior que
    console.log(10 > 5) //verdadeiro = true
    console.log(`10 > 5 - ${ 10 > 5 }`) //Para trazer a introduçao antes do resultado com interpolaçao
    ...
    //igualdadde de valores e tipo de dado
